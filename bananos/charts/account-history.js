...
function formatBytes(a,b){if(0==a)return"0 Bytes";var c=1024,d=b||2,e=["Bytes","K","M","G","T","P","E","Z","Y"],f=Math.floor(Math.log(a)/Math.log(c));return parseFloat((a/Math.pow(c,f)).toFixed(d))+" "+e[f]}
    ...
    d3.json("account-history.json", function(response) {
      const limit = 200000;
        ...
        nodeList.forEach(function(d) {
          console.log('true node',name(d.account),formatBytes3(d.balance));
